...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('AdminController')->group(function () {
        Route::get('dashboard', 'dashboard')->name('dashboard')->middleware('permission:Manage Dashboard');
    ...
    // Category Manager
    Route::controller('CategoryController')->name('category.')->middleware("permission:Manage Category")->prefix('category')->group(function () {
    ...
    // Subscriber
    Route::controller('SubscriberController')->prefix('subscriber')->middleware("permission:Manage Subscriber")->name('subscriber.')->group(function () {
        Route::get('/', 'index')->name('index');
