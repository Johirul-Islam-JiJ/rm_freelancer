    ...
    <div class="profile-widget">
        <div class="profile-widget-header">
            <div class="profile-widget-thumb">
                <img src="{{ getImage(getFilePath('userBgImage').'/'.$productDetails->user->bg_image, getFileSize('userBgImage')) }}">
            </div>
            <div class="profile-widget-author">
                <div class="thumb">
                    <img src="{{ getImage(getFilePath('userProfile').'/'.$productDetails->user->image, getFileSize('userProfile')) }}">
                </div>
                <div class="content">
                    <h4 class="name">
