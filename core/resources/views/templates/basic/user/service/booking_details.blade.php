...
<div class="card custom--card">
    ...
    <div class="card-body">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                @lang('Delivery Date')
                <span class="fw-bold">{{showDateTime($details->created_at->addDays($details->service->delivery_time),
                    ('M, d - Y'))}}</span>
            </li>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="text-center">
                    ...
                    <span class="text--info">
                        <a href="{{route('public.profile', $details->disputer->username)}}"><span>@</span>{{
                            $details->disputer->username }}</a>
                    </span>
                </div>
            </li>
            @endif
