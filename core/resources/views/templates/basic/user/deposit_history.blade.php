    ...
    <div class="row justify-content-end gy-3">
        <div class="col-lg-8  text-end">
            <form class="d-flex gap-3 align-items-center justify-content-end">
                ...
                <a class="btn btn--base p-2-5" href="{{ route('user.deposit.index') }}">@lang('New Service')</a>
            </form>
        </div>
        <div class="col-12">
                    ...
                    <tbody>
                        @forelse($deposits as $deposit)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn--primary btn--sm  @if ($deposit->method_code >= 1000) detailBtn @else disabled @endif" data-bs-toggle="tooltip" data-bs-placement="top" type="button" title="@lang('Details')" @if ($deposit->method_code >= 1000) data-info="{{ $details }}" @endif @if ($deposit->status == Status::PAYMENT_REJECT) data-admin_feedback="{{ $deposit->admin_feedback }}" @endif>
